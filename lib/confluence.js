...
module.exports = async function getConfluenceData(shortname) {
  let implementationData;
  try {
    implementationData = await fetchJSON(`https://dontcallmedom.github.io/webrtc-impl-tracker/${shortname}.json`);
  } catch (e) {
